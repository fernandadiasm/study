# Enviar o diretório local “/input/exercises-data/juros_selic” para o HDFS em “/user/aluno/<nome>/data”
...
# Mostrar os 5 primeiros registros do jutosDF
...
# Criar o DataFrame jurosHDFS para ler o diretório do “save_juros” da questão 8
