# Importar a tabela employees.titles do MySQL para o diretório /user/aluno/<nome>/data com 1 mapeador.
...
# Importar a tabela employees.titles do MySQL para uma tabela Hive no banco de dados seu nome com 1 mapeador.
...
# Selecionar os 10 primeiros registros da tabela titles no Hive.
...
# Deletar os registros da tabela employees.titles do MySQL e verificar se foram apagados, através do Sqoop
...
# Exportar os dados do diretório /user/hive/warehouse/<nome>.db/data/titles para a tabela do MySQL  employees.titles.
...
# Selecionar os 10 primeiros registros registros da tabela employees.titles do MySQL.
