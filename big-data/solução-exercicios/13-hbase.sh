# Criar a tabela ‘controle’ com os dados
...
#  Listar as tabelas e verificar a estrutura da tabela ‘controle’
...
#  Contar o número de registros da tabela ‘controle’

hbase(main):027:0> count 'controle'

#  Alterar  a família de coluna produto para 3 versões

hbase(main):028:0> alter 'controle', {NAME=>'produto',VERSIONS=>3}

#  Alterar a quantidade para 200 do id 2

hbase(main):029:0> put 'controle','2','produto:qtd','200'

#  Pesquisar as versões do id 2  da coluna quantidade
...
#  Deletar a coluna estado da chave 2

hbase(main):040:0> delete 'controle','2','fornecedor:estado'

#  Pesquisar toda a tabela controle
